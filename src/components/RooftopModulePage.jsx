          ...
          <div className="bg-slate-800/50 rounded-2xl border border-slate-700/50 p-6">
            ...
            <div className="aspect-video rounded-xl overflow-hidden bg-slate-900">
              <iframe
                width="100%"
                height="100%"
                src={`https://www.youtube-nocookie.com/embed/${moduleData.videoId}?rel=0&modestbranding=1`}
            ...
            <a
              href={`https://www.youtube.com/watch?v=${moduleData.videoId}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mt-3 text-sm text-slate-400 hover:text-white transition-colors"
            >
