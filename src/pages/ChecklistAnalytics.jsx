...
export default function ChecklistAnalytics() {
  ...
  const [viewMode, setViewMode] = useState('overview'); // 'overview', 'pilots', 'sessions'
                          ...
                          {timerStart && (
                            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3 mb-3">
                              ...
                              <div className="space-y-1 text-xs text-slate-400">
                                <div>Started: {format(new Date(timerStart.created_date), 'h:mm:ss a')}</div>
                                {timerComplete && (
                                  <>
                                    <div>Completed: {format(new Date(timerComplete.created_date), 'h:mm:ss a')}</div>
                              ...
                              return (
                                <div key={idx} className={cn(
                                  ...
                                  <span className="text-xs text-slate-500 min-w-[60px]">
                                    {format(new Date(activity.created_date), 'h:mm:ss a')}
                                  </span>
                                  <span className={cn(
                                    "text-slate-400",
