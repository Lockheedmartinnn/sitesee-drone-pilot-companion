...
const QUIZ_QUESTIONS = [
  ...
  {
    id: 3,
    question: "What should you do after a battery swap?",
    options: [
  ...
  {
    id: 4,
    question: "When marking obstacles, what buffer should you add above their actual height?",
    options: ["No buffer needed", "+2m buffer", "+4m buffer", "+6m buffer"],
    correct: 2
  },
  {
    id: 5,
    question: "What camera mode should you use during capture?",
    options: ["Auto mode", "Manual mode with locked settings", "Semi-auto mode", "Any mode is fine"],
    correct: 1
  },
  {
    id: 6,
  ...
  {
    id: 9,
    question: "For rooftop captures, where must you land during battery swaps?",
    options: [
      "Anywhere safe on the roof",
      "On the ground",
      "At the EXACT SAME takeoff location",
      "Near the equipment"
    ],
    correct: 2
  },
  {
    id: 10,
    question: "What should you do before leaving the site?",
    options: [
      "Just pack up and go",
      "Spot check exposure and alignment",
      "Wait for back office approval",
      "Delete any bad photos"
    ],
    correct: 1
  }
];
...
export default function MissionMarkupQuiz() {
  ...
  const { data: previousAttempts = [] } = useQuery({
    ...
    queryFn: () => base44.entities.QuizAttempt.filter({ 
      pilot_id: user?.email, 
      quiz_id: 'mission-markup-fundamentals' 
    }),
    enabled: !!user?.email
  });
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white">
        <div className="max-w-4xl mx-auto px-5 py-6 pb-20">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold">Mission Markup Training</h1>
          ...
          <div className="bg-slate-800/50 rounded-2xl overflow-hidden border border-slate-700 mb-6">
            ...
            <div className="p-6">
              <h3 className="font-semibold text-lg mb-2">SiteSee Mission Markup Fundamentals</h3>
              <p className="text-sm text-slate-400 mb-4">
                Learn the essential concepts and procedures for mission markup, GPS stabilization, and quality capture.
              </p>
              <Button
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">
              {results.passed 
                ? "Great work! You've demonstrated understanding of mission markup fundamentals."
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white flex items-center justify-center p-5">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">10 questions about mission markup fundamentals</p>
          </div>
